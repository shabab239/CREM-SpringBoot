...
(10,-500000,'ABC Properties Ltd. Company A/C',1,NULL,NULL,NULL,1),
...
insert  into `const_units`(`id`,`company_id`,`name`,`price`,`size`,`status`,`type`,`floor_id`) values 
(1,1,'Unit 101',500000,120,'AVAILABLE','APARTMENT',1);
...
(1,1,'Task A','2024-11-22','2024-11-16','IN_PROGRESS');
