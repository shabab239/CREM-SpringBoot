...
(1,-15129,1,'Shabab Ahmed Cash A/C'),
(2,15129,1,'Supplier A Cash A/C'),
...
insert  into `acc_transactions`(`id`,`amount`,`company_id`,`group_transaction_id`,`transaction_date`,`type`,`account_id`) values 
(1,15129,1,'743d2818-3a0d-45cf-b8bd-088305756841','2024-10-02 10:56:52.000000','DEBIT',2),
(2,15129,1,'743d2818-3a0d-45cf-b8bd-088305756841','2024-10-02 10:56:52.000000','CREDIT',1);
...
insert  into `const_raw_material_orders`(`id`,`company_id`,`delivery_date`,`order_date`,`quantity`,`status`,`total_price`,`unit_price`,`raw_material_id`,`supplier_id`,`group_transaction_id`) values 
(2,1,NULL,'2024-10-02',123,1,15129,123,2,1,'743d2818-3a0d-45cf-b8bd-088305756841');
...
insert  into `const_raw_material_stocks`(`id`,`company_id`,`last_updated`,`quantity`,`raw_material_id`) values 
(2,1,'2024-10-02 10:56:52.000000',123,2);
